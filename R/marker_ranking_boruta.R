...
#' @description Function to run Boruta on the stimulation - cell population combinations
#'              that passed the Fisher's exact test to rank the markers
#'              according to their contribution to the response detected by HDStIM.
#' @param mapped_data      Returned list from the \code{\link{HDStIM}} functionn.
#' @param path             Path to the folder to save figures generated by this function.
#' @param max_runs         Maximum number of runs for the random forest algorithm.
#'                         Default is 100.
...
#'                                         verbose = FALSE)
#' }
marker_ranking_boruta <- function(mapped_data, path = NULL, n_cells = 5000, max_runs = 100, seed_val = 123, verbose = 0){
