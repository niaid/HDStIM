...
```{r stacked_plot, fig.width = 6, fig.height = 4}
...
#   labs(title=paste("Cluster:", unique(split_groups[[1]]$cell_population), 
...
```{r umap_kde, fig.width = 16, fig.height = 9}
# library(tidyr)
# library(ggridges)
# 
...
# 
#     kde_plot <- p + facet_wrap( ~ state_marker, nrow = 3, ncol = 4) +
